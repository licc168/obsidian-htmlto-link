/**
 * Vendored from the `obsidian` npm package for the community-plugin audit.
 * The review type-checker does not install that package, so `import "obsidian"`
 * otherwise becomes the TypeScript `error` type and floods no-unsafe-* warnings.
 * Source: obsidian@1.13.1 (https://github.com/obsidianmd/obsidian-api)
 */

...
const dict = {
  en: {
    ...
    commandFocusTemplatePreview: "Focus template preview controls",
    ...
    languageEn: "English",
    languageZh: "中文",
		previewOriginal: "Obsidian original",
		previewTemplateLabel: "Template",
		previewTemplateAriaLabel: "Choose a local preview template",
		previewThemeLabel: "Theme",
		previewThemeAriaLabel: "Choose a local preview theme",
		previewLocalStatus: "Local · not published",
		previewPublishButton: "Publish",
		previewPublishingButton: "Publishing…",
		previewPublishAriaLabel: "Publish this note",
		previewCopied: "Copied",
		previewCopyFailed: "Copy failed",
		previewTocTitle: "Contents",
		previewTocAriaLabel: "Page contents",
		previewTocCollapse: "Collapse",
		previewTocExpand: "Expand",
    ...
    previewTemplateLink: "Preview template styles",
    themeName: "Theme",
    ...
    openLink: "Open link",
    renewLink: "Renew to keep this link alive",
    copied: "Copied",
    copyLink: "Copy link",
  ...
  zh: {
    ...
    commandFocusTemplatePreview: "聚焦模板预览控件",
    menuPublish: "分享这篇笔记",
    ...
    languageEn: "English",
    languageZh: "中文",
		previewOriginal: "Obsidian 原样",
		previewTemplateLabel: "模板",
		previewTemplateAriaLabel: "选择本地预览模板",
		previewThemeLabel: "主题",
		previewThemeAriaLabel: "选择本地预览主题",
		previewLocalStatus: "本地 · 未发布",
		previewPublishButton: "发布",
		previewPublishingButton: "发布中…",
		previewPublishAriaLabel: "发布当前笔记",
		previewCopied: "已复制",
		previewCopyFailed: "复制失败",
		previewTocTitle: "目录",
		previewTocAriaLabel: "页面目录",
		previewTocCollapse: "收起",
		previewTocExpand: "展开",
